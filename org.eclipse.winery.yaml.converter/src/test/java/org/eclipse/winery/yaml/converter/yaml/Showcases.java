...
public class Showcases extends AbstractTestY2X {
	...
	public void nodeTypesTest() throws Exception {
		String path = "nodetypes/http%3A%2F%2Fopentosca.org%2Fnodetypes";
	...
	public void serviceTemplateTest() throws Exception {
		String path = "servicetemplates/http%3A%2F%2Fopentosca.org%2Fservicetemplates";
		String namespace = "http://opentosca.org/servicetemplates";
		Stream<String> files = Stream.of(
